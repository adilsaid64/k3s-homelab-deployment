...
export class ProxmoxGroup extends pulumi.ComponentResource {
  ...
  constructor(name: string, args: ProxmoxGroupArgs, opts?: pulumi.ComponentResourceOptions) {
...
export class ProxmoxAccount extends pulumi.ComponentResource {
  ...
  constructor(name: string, args: ProxmoxAccountArgs, opts?: pulumi.ComponentResourceOptions) {
