...
export class ProxmoxK3sWorker extends pulumi.ComponentResource {
  ...
  constructor(name: string, args: ProxmoxWorkerArgs, opts?: pulumi.ComponentResourceOptions) {
    super('custom:infra:ProxmoxWorker', name, {}, opts);
